...
for algorithm in algorithms:
	#CWND
	time_0, average_cwnd_0, time_1, average_cwnd_1 = cwndupdated.get_time_and_averages(iterations, algorithm)
	cwndupdated.plot_flows(time_0, average_cwnd_0, time_1, average_cwnd_1, algorithm)
